  ...
  render() {
    return (
      <div>
        ...
        <GHPCard header="Number of Followers" title={this.state.user.numFollowers}/>
        <GHPCard header="Number of Following" title={this.state.user.numFollowing}/>
        <GHPCard header="Number of Repositories" title={this.state.user.numRepos}/>
      </div>
    );
  }
}
